...
const fhss_config_t domainsDualBand[] = {
    {"KC2G4", FREQ_HZ_TO_REG_VAL(2420400000), FREQ_HZ_TO_REG_VAL(2479400000), 60, 2440000000}
};
#endif
...
const fhss_config_t domains[] = {
    {
        ...
        "KC2G4",
    #endif
    FREQ_HZ_TO_REG_VAL(2420400000), FREQ_HZ_TO_REG_VAL(2479400000), 80, 2440000000}
};
#endif
