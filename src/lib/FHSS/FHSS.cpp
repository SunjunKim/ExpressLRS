...
const fhss_config_t domains[] = {
    ...
    {"KC_LOW", FREQ_HZ_TO_REG_VAL(2420000000), FREQ_HZ_TO_REG_VAL(2420000000), 3},
    {"KC_MID", FREQ_HZ_TO_REG_VAL(2449000000), FREQ_HZ_TO_REG_VAL(2449000000), 3},
    {"KC_HIGH", FREQ_HZ_TO_REG_VAL(2479000000), FREQ_HZ_TO_REG_VAL(2479000000), 3}
};
#endif
