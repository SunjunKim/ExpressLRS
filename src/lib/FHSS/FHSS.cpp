...
const fhss_config_t domains[] = {
    {    
        ...
        "ISM2G4",
    #endif
    FREQ_HZ_TO_REG_VAL(2403400000), FREQ_HZ_TO_REG_VAL(2479400000), 77},
    {"KC_LOW", FREQ_HZ_TO_REG_VAL(2403400000), FREQ_HZ_TO_REG_VAL(2403400000), 3},
    {"KC_MID", FREQ_HZ_TO_REG_VAL(2439400000), FREQ_HZ_TO_REG_VAL(2439400000), 3},
    {"KC_HIGH", FREQ_HZ_TO_REG_VAL(2479400000), FREQ_HZ_TO_REG_VAL(2479400000), 3}
};
#endif
