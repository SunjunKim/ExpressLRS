...
expresslrs_mod_settings_s ExpressLRS_AirRateConfig[RATE_MAX] = {
    ...
    {0,  RADIO_TYPE_LR1121_LORA_2G4,  RATE_LORA_500HZ,               LR11XX_RADIO_LORA_BW_800,       LR11XX_RADIO_LORA_SF5, LR11XX_RADIO_LORA_CR_LI_4_6, 12,       LR11XX_RADIO_LORA_BW_800,       LR11XX_RADIO_LORA_SF5, LR11XX_RADIO_LORA_CR_LI_4_6, 12, TLM_RATIO_1_128, 4,  2000, OTA4_PACKET_SIZE, 1},
    {1,  RADIO_TYPE_LR1121_LORA_2G4,  RATE_LORA_333HZ_8CH,           LR11XX_RADIO_LORA_BW_800,       LR11XX_RADIO_LORA_SF5, LR11XX_RADIO_LORA_CR_LI_4_8, 12,       LR11XX_RADIO_LORA_BW_800,       LR11XX_RADIO_LORA_SF5, LR11XX_RADIO_LORA_CR_LI_4_8, 12, TLM_RATIO_1_128, 4,  3003, OTA8_PACKET_SIZE, 1},
    {2,  RADIO_TYPE_LR1121_LORA_2G4,  RATE_LORA_250HZ,               LR11XX_RADIO_LORA_BW_800,       LR11XX_RADIO_LORA_SF6, LR11XX_RADIO_LORA_CR_LI_4_8, 14,       LR11XX_RADIO_LORA_BW_800,       LR11XX_RADIO_LORA_SF6, LR11XX_RADIO_LORA_CR_LI_4_8, 14,  TLM_RATIO_1_64, 4,  4000, OTA4_PACKET_SIZE, 1},
    {3,  RADIO_TYPE_LR1121_LORA_2G4,  RATE_LORA_150HZ,               LR11XX_RADIO_LORA_BW_800,       LR11XX_RADIO_LORA_SF7, LR11XX_RADIO_LORA_CR_LI_4_8, 12,       LR11XX_RADIO_LORA_BW_800,       LR11XX_RADIO_LORA_SF7, LR11XX_RADIO_LORA_CR_LI_4_8, 12,  TLM_RATIO_1_32, 4,  6666, OTA4_PACKET_SIZE, 1},
...
expresslrs_rf_pref_params_s ExpressLRS_AirRateRFperf[RATE_MAX] = {
    ...
    // {2,  -117,  8770, 3500, 2500, 600,  5000, SNR_SCALE( 1), SNR_SCALE(2.5)},
    // {3,  -120, 18560, 4000, 2500, 600,  5000, SNR_SCALE(-1), SNR_SCALE(1.5)},
    {0,  -105,  1507, 2500, 2500,   3,  5000, SNR_SCALE( 5), SNR_SCALE(9.5)},
    {1,  -105,  2374, 2500, 2500,   4,  5000, SNR_SCALE( 5), SNR_SCALE(9.5)},
    {2,  -108,  3300, 3000, 2500,   6,  5000, SNR_SCALE( 3), SNR_SCALE(9.5)},
    {3,  -112,  5871, 3500, 2500,  10,  5000, SNR_SCALE( 0), SNR_SCALE(8.5)},
